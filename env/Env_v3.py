...
class CentralizedMultiRobotEnv(gym.Env):
    ...
    def __init__(self, max_episode_steps, num_robots, robot_radius=0.5, render_mode=None):
        super().__init__()
        ...
        # Actions are one shared distance for all robots + heading change per robot
        # Action format: [shared_distance, dtheta_robot1, dtheta_robot2, ..., dtheta_robotN]
